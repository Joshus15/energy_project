...
def get_cpu_data(): 
    ...
    def Process1():
        ...
        for i in range(seconds): 
            cpu = p.cpu_percent(1)/psutil.cpu_count()
            CPU_usage1.append(cpu)
    
            print('The CPU usage1 is: ', cpu,'%')
